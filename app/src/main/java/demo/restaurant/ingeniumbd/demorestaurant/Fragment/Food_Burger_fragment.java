 ...
 */
public class Food_Burger_fragment extends Fragment implements Food_Adapter.ClickListenerFood {

    Food_Adapter food_adapter;
    RecyclerView recyclerView;
    public Food_Burger_fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(demo.restaurant.ingeniumbd.demorestaurant.R.layout.fragment_food__burger_fragment, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView)getActivity().findViewById(demo.restaurant.ingeniumbd.demorestaurant.R.id.rec_list_Burger);

        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity().getApplicationContext()));

        food_adapter = new Food_Adapter(FoodData.getFoodListData(),getActivity().getApplicationContext(),"Burger");
