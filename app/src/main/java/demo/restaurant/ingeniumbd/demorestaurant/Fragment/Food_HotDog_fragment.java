 ...
 */
public class Food_HotDog_fragment extends Fragment implements Food_Adapter.ClickListenerFood{

    Food_Adapter food_adapter;
    RecyclerView recyclerView;

    public Food_HotDog_fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_food__hot_dog_fragment, container, false);
    }
    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        recyclerView = (RecyclerView)getActivity().findViewById(R.id.rec_list_HotDog);

        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity().getApplicationContext()));

        food_adapter = new Food_Adapter(FoodData.getFoodListData(),getActivity().getApplicationContext(),"HotDog");
