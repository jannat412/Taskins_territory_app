 ...
 */
public class Food_Sandwich_fragment extends Fragment implements Food_Adapter.ClickListenerFood{


    Food_Adapter food_adapter;
    RecyclerView recyclerView;
    public Food_Sandwich_fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(demo.restaurant.ingeniumbd.demorestaurant.R.layout.fragment_food__sandwich_fragment, container, false);
    }

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        recyclerView = (RecyclerView)getActivity().findViewById(demo.restaurant.ingeniumbd.demorestaurant.R.id.rec_list_Sandwich);

        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity().getApplicationContext()));

        food_adapter = new Food_Adapter(FoodData.getFoodListData(),getActivity().getApplicationContext(),"Sandwich");
